...
module.exports = function(){
  ...
  // - setTimeout
    ...
    notify = function(){
      // strange IE + webpack dev src bug - use .call(global)
...
'use strict';
// 19.1.2.1 Object.assign(target, src, ...)
var getKeys  = _dereq_(76)
  , gOPS     = _dereq_(73)
  , pIE      = _dereq_(77)
  , toObject = _dereq_(109)
...
// 19.1.3.1 Object.assign(target, src)
var $export = _dereq_(32);
 ...
 * All rights reserved.
 *
 * This src code is licensed under the BSD-style license found in the
